...
var SRT_SELECTORS_DEFAULT = {
  ...
  gemini: {
    ...
    assistantNode: ['model-response', '.model-response-text'],
    responseInner: '.model-response-text',
    generating: 'button[aria-label="Stop response"], button[aria-label="Dừng câu trả lời"], .stop-icon, .streaming',
    stop: 'button[aria-label="Stop response"], button[aria-label="Dừng câu trả lời"]',
